<footer class="mt-auto border-t border-slate-800 bg-slate-900 pb-8 pt-16 text-slate-400">
    ...
    <div class="mb-12 grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
      <div class="flex flex-col gap-5 lg:col-span-2">
        <div class="flex items-center gap-3">
          ...
          <span class="text-lg font-bold text-white">Upturn Business Solutions</span>
        </div>
        ...
        <div class="flex gap-3">
          <a href="https://www.tiktok.com/@upturnbusinesssolutions" target="_blank" rel="noopener noreferrer" aria-label="TikTok" class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-[#1152d4] hover:text-white">
          ...
          <a href="https://www.linkedin.com/in/upturn-business-solutions-615238271/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-[#1152d4] hover:text-white">
          ...
          <a href="https://www.instagram.com/upturn.businesssolutions/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-[#1152d4] hover:text-white">
          ...
          <a href="https://www.facebook.com/UpturnBusinessSolutions/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" class="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 transition-colors hover:bg-[#1152d4] hover:text-white">
      ...
      <div>
        ...
        <ul class="flex flex-col gap-3 text-sm">
          ...
          <li><a href="{{ route('services') }}" class="transition-colors hover:text-white">Services</a></li>
          <li><a href="{{ route('about') }}" class="transition-colors hover:text-white">About Us</a></li>
          <li><a href="{{ route('engagements') }}" class="transition-colors hover:text-white">Engagements</a></li>
          <li><a href="{{ route('careers') }}" class="transition-colors hover:text-white">Careers</a></li>
      ...
      <div>
        ...
        <ul class="flex flex-col gap-4 text-sm">
          <li class="flex items-start gap-3">
            ...
            <span>{{ $siteSettings->get('contact_address', 'Unit 1 LJ Building, Maysan Rd, Llenado Compound Malinta, Valenzuela City NCR Philippines') }}</span>
          </li>
          <li class="flex items-start gap-3">
            <span class="material-symbols-outlined mt-0.5 text-base text-[#1152d4]">call</span>
            <div class="flex flex-col gap-1">
              <a href="tel:{{ preg_replace('/[^0-9+]/', '', $siteSettings->get('contact_phone', '+63 921 551 4785')) }}" class="transition-colors hover:text-white">{{ $siteSettings->get('contact_phone', '+63 921 551 4785') }}</a>
            </div>
          </li>
          <li class="flex items-center gap-3">
            <span class="material-symbols-outlined text-base text-[#1152d4]">mail</span>
            <a href="mailto:{{ $siteSettings->get('contact_email', 'upturnph@upturnph.com') }}" class="transition-colors hover:text-white">{{ $siteSettings->get('contact_email', 'upturnph@upturnph.com') }}</a>
          </li>
          <li class="flex items-center gap-3">
